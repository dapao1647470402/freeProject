...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
	 ...
	 *
	 * @param css
	 *            the Strings to check, may be null or empty
	 * @return {@code true} if any of the Strings are empty or null
	 * @since 3.2
	 */
	...
	/**
	 * <p>
	 * Checks if none of the Strings are empty ("") or null.
	 * </p>
	 *
	 * <pre>
	 ...
	 * @param css
	 *            the Strings to check, may be null or empty
	 * @return {@code true} if none of the Strings are empty or null
	 * @since 3.2
	 */
	...
	/**
	 * <p>
	 * Checks if all of the Strings are empty ("") or null.
	 * </p>
	 *
	 * <pre>
	 ...
	 * @param css
	 *            the Strings to check, may be null or empty
	 * @return {@code true} if all of the Strings are empty or null
	 * @since 3.6
	 */
	 ...
	 * @since 2.0
	 * @since 3.0 Changed signature from isBlank(String) to isBlank(String)
	 */
	...
	/**
	 * <p>
	 * Checks if any of the Strings are empty ("") or null or whitespace only.
	 * </p>
	 *
	 * <p>
	 * Whitespace is defined by {@link Character#isWhitespace(char)}.
	 ...
	 * @param css
	 *            the Strings to check, may be null or empty
	 * @return {@code true} if any of the Strings are empty or null or
	 *         whitespace only
	 * @since 3.2
	 */
	...
	/**
	 * <p>
	 * Checks if none of the Strings are empty (""), null or whitespace only.
	 * </p>
	 *
	 * <p>
	 * Whitespace is defined by {@link Character#isWhitespace(char)}.
	 ...
	 * @param css
	 *            the Strings to check, may be null or empty
	 * @return {@code true} if none of the Strings are empty or null or
	 *         whitespace only
	 * @since 3.2
	 */
	...
	/**
	 * <p>
	 * Checks if all of the Strings are empty (""), null or whitespace only.
	 * </p>
	 *
	 * <p>
	 * Whitespace is defined by {@link Character#isWhitespace(char)}.
	 ...
	 * @param css
	 *            the Strings to check, may be null or empty
	 * @return {@code true} if all of the Strings are empty or null or
	 *         whitespace only
	 * @since 3.6
	 */
	 ...
	 *            the String to compare to
	 * @param nullIsLess
	 *            whether consider {@code null} value less than non-{@code null}
	 *            value
	 ...
	 * <p>
	 * {@code null} value is considered less than non-{@code null} value. Two
	 * {@code null} references are considered equal. Comparison is case
	 * insensitive.
	 * </p>
	 *
	 * <pre>
	 ...
	 * <p>
	 * {@code null} inputs are handled according to the {@code nullIsLess}
	 * parameter. Two {@code null} references are considered equal. Comparison
	 * is case insensitive.
	 * </p>
	 *
	 * <pre>
	...
	/**
	 * <p>
	 * Compares given <code>string</code> to a Strings vararg of
	 * <code>searchStrings</code>, returning {@code true} if the
	 * <code>string</code> is equal to any of the <code>searchStrings</code>.
	 * </p>
	 *
	 * <pre>
	 * StringUtils.equalsAny(null, (String[]) null) = false
	...
	public static boolean equalsAny(final String string, final String... searchStrings) {
		if (ArrayUtils.isNotEmpty(searchStrings)) {
			for (final String next : searchStrings) {
	 ...
	 *
	 * <pre>
	 * StringUtils.equalsAnyIgnoreCase(null, (String[]) null) = false
	 ...
	 *         other element of <code>searchStrings</code>; {@code false} if
	 *         <code>searchStrings</code> is null or contains no matches.
	 * @since 3.5
	 */
	 ...
	 * specified character. If a character with value <code>searchChar</code>
	 * occurs in the character sequence represented by <code>seq</code>
	 * <code>String</code> object, then the index (in Unicode code units) of the
	 * first such occurrence is returned. For values of <code>searchChar</code>
	 ...
	 *
	 * <p>
	 * Furthermore, a {@code null} or empty ("") String will return
	 ...
	 * @since 2.0
	 * @since 3.0 Changed signature from indexOf(String, int) to indexOf(String,
	 *        int)
	 * @since 3.6 Updated {@link StringUtils} call to behave more like
	 *        <code>String</code>
	 */
	public static int indexOf(final String seq, final int searchChar) {
		...
		return StringUtils.indexOf(seq, searchChar, 0);
	}
	 ...
	 * sequence represented by the <code>seq</code> <code>String</code> object
	 * at an index no smaller than <code>startPos</code>, then the index of the
	 * first such occurrence is returned. For values of <code>searchChar</code>
	 * in the range from 0 to 0xFFFF (inclusive), this is the smallest value
	 * <i>k</i> such that: <blockquote>
	 *
	 ...
	 *
	 * </blockquote> is true. In either case, if no such character occurs in
	 * <code>seq</code> at or after position <code>startPos</code>, then
	 * <code>-1</code> is returned.
	 *
	 * <p>
	 * There is no restriction on the value of <code>startPos</code>. If it is
	 ...
	 * {@code (INDEX_NOT_FOUND) -1} is returned. Furthermore, a {@code null} or
	 * empty ("") String will return {@code (INDEX_NOT_FOUND) -1}.
	 *
	 * <p>
	 ...
	 *        <code>String</code>
	 */
	public static int indexOf(final String seq, final int searchChar, final int startPos) {
		if (isEmpty(seq)) {
			return INDEX_NOT_FOUND;
		}
	...
	/**
	 * <p>
	 * Finds the first index within a String, handling {@code null}. This method
	 * uses {@link String#indexOf(String, int)} if possible.
	 * </p>
	 *
	 * <p>
	 ...
	 * @param startPos
	 *            the start position, negative treated as zero
	 * @return the first index of the search String (always &ge; startPos), -1
	 ...
	 * </p>
	 * <p>
	 * <b>Note:</b> The code starts looking for a match at the start of the
	 * target, incrementing the starting index by one after each successful
	 * match (unless {@code searchStr} is an empty string in which case the
	 * position is never incremented and {@code 0} is returned immediately).
	 ...
	 *            the String to find, may be null
	 * @param ordinal
	 *            the n-th {@code searchStr} to find, overlapping matches are
	 *            allowed.
	 * @param lastIndex
	...
	// -----------------------------------------------------------------------
	/**
	 * Returns the index within <code>seq</code> of the last occurrence of the
	 * specified character. For values of <code>searchChar</code> in the range
	 * from 0 to 0xFFFF (inclusive), the index (in Unicode code units) returned
	 * is the largest value <i>k</i> such that: <blockquote>
	 *
	 * <pre>
	 * this.charAt(<i>k</i>) == searchChar
	 * </pre>
	 ...
	 *
	 * </blockquote> is true. In either case, if no such character occurs in
	 * this string, then <code>-1</code> is returned. Furthermore, a
	 * {@code null} or empty ("") <code>String</code> will return {@code -1}.
	 * The <code>seq</code> <code>String</code> object is searched backwards
	 ...
	 *        <code>String</code>
	 */
	public static int lastIndexOf(final String seq, final int searchChar) {
		if (isEmpty(seq)) {
			return INDEX_NOT_FOUND;
		}
		return StringUtils.lastIndexOf(seq, searchChar, seq.length());
	}
	 ...
	 *
	 * </blockquote> is true. In either case, if no such character occurs in
	 * <code>seq</code> at or before position <code>startPos</code>, then
	 * <code>-1</code> is returned. Furthermore, a {@code null} or empty ("")
	 * <code>String</code> will return {@code -1}. A start position greater than
	 * the string length searches the whole string. The search starts at the
	 * <code>startPos</code> and works backwards; matches starting after the
	 ...
	 */
	public static int lastIndexOf(final String seq, final int searchChar, final int startPos) {
		if (isEmpty(seq)) {
			return INDEX_NOT_FOUND;
		}
	...
	/**
	 * <p>
	 * Finds the last index within a String, handling {@code null}. This method
	 * uses {@link String#lastIndexOf(String)} if possible.
	 * </p>
	 *
	 * <p>
	 * A {@code null} String will return {@code -1}.
	 ...
	 */
	public static int lastIndexOf(final String seq, final String searchSeq) {
		if (seq == null || searchSeq == null) {
			return INDEX_NOT_FOUND;
		}
		return StringUtils.lastIndexOf(seq, searchSeq, seq.length());
	}
	 ...
	 * @return the n-th last index of the search String, {@code -1} (
	 *         {@code INDEX_NOT_FOUND}) if no match or {@code null} string input
	 * @since 2.5
	 * @since 3.0 Changed signature from lastOrdinalIndexOf(String, String, int)
	 *        to lastOrdinalIndexOf(String, String, int)
	 */
	 ...
	 * <p>
	 * Finds the last index within a String, handling {@code null}. This method
	 * uses {@link String#lastIndexOf(String, int)} if possible.
	 * </p>
	 *
	 * <p>
	 * A {@code null} String will return {@code -1}. A negative start position
	 * returns {@code -1}. An empty ("") search String always matches unless the
	 * start position is negative. A start position greater than the string
	 * length searches the whole string. The search starts at the startPos and
	 * works backwards; matches starting after the start position are ignored.
	 * </p>
	 *
	 * <pre>
	 * StringUtils.lastIndexOf(null, *, *)          = -1
	 ...
	 * @param startPos
	 *            the start position, negative treated as zero
	 * @return the last index of the search String (always &le; startPos), -1 if
	 ...
	 *        to lastIndexOfIgnoreCase(String, String)
	 */
	...
	/**
	 * <p>
	 * Checks if String contains a search character, handling {@code null}. This
	...
	public static boolean contains(final String seq, final int searchChar) {
		...
		return StringUtils.indexOf(seq, searchChar, 0) >= 0;
	}

	/**
	 * <p>
	 * Checks if String contains a search String, handling {@code null}. This
	...
	public static boolean contains(final String seq, final String searchSeq) {
		...
		return StringUtils.indexOf(seq, searchSeq, 0) >= 0;
	}
	 ...
	 */
	public static int indexOfAny(final String cs, final char... searchChars) {
	 ...
	 */
	public static int indexOfAny(final String cs, final String searchChars) {
	 ...
	 *
	 * <p>
	 * A {@code null} String will return {@code false}. A {@code null} or zero
	 ...
	 */
	public static boolean containsAny(final String cs, final char... searchChars) {
		if (isEmpty(cs) || ArrayUtils.isEmpty(searchChars)) {
			return false;
		}
	 ...
	 *
	 * <p>
	 * A {@code null} {@code cs} String will return {@code false}. A
	 ...
	 *            The String to check, may be null
	 * @param searchStrings
	 *            The array of Strings to search for, may be null. Individual
	 *            Strings may be null as well.
	 * @return {@code true} if any of the search Strings are found,
	 *         {@code false} otherwise
	 * @since 3.4
	 */
	public static boolean containsAny(final String cs, final String... searchStrings) {
		if (isEmpty(cs) || ArrayUtils.isEmpty(searchStrings)) {
			return false;
		}
		for (final String searchString : searchStrings) {
			if (contains(cs, searchString)) {
				return true;
			}
		}
		return false;
	...
	/**
	 * <p>
	 * Searches a String to find the first index of any character not in the
	 ...
	 */
	public static int indexOfAnyBut(final String cs, final char... searchChars) {
		if (isEmpty(cs) || ArrayUtils.isEmpty(searchChars)) {
			return INDEX_NOT_FOUND;
		}
		final int csLen = cs.length();
	 ...
	 *
	 * <p>
	 * A {@code null} String will return {@code -1}. A {@code null} or empty
	 ...
	 */
	public static int indexOfAnyBut(final String seq, final String searchChars) {
		...
		for (int i = 0; i < strLen; i++) {
			...
			final boolean chFound = StringUtils.indexOf(searchChars, ch, 0) >= 0;
			if (i + 1 < strLen && Character.isHighSurrogate(ch)) {
				final char ch2 = seq.charAt(i + 1);
				if (chFound && StringUtils.indexOf(searchChars, ch2, 0) < 0) {
					return i;
				}
			} else {
				if (!chFound) {
	 ...
	 * character array will return {@code false}. An empty String (length()=0)
	 ...
	 */
	public static boolean containsOnly(final String cs, final char... valid) {
	 ...
	 */
	public static boolean containsOnly(final String cs, final String validChars) {
	 ...
	 *
	 * <p>
	 * A {@code null} String will return {@code true}. A {@code null} invalid
	 * character array will return {@code true}. An empty String (length()=0)
	 * always returns true.
	 * </p>
	 *
	 * <pre>
	 ...
	 */
	public static boolean containsNone(final String cs, final char... searchChars) {
	 ...
	 * <p>
	 * A {@code null} String will return {@code true}. A {@code null} invalid
	 * character array will return {@code true}. An empty String ("") always
	 * returns true.
	 * </p>
	 *
	 * <pre>
	 ...
	 */
	public static boolean containsNone(final String cs, final String invalidChars) {
	 ...
	 * entry will be ignored, but a search array containing "" will return
	...
	public static int indexOfAny(final String str, final String... searchStrs) {
		...
		for (final String search : searchStrs) {
			...
			tmp = StringUtils.indexOf(str, search, 0);
	 ...
	 * will be ignored, but a search array containing "" will return the length
	 * of {@code str} if {@code str} is not null. This method uses
	 * {@link String#indexOf(String)} if possible
	 * </p>
	 *
	 * <pre>
	...
	public static int lastIndexOfAny(final String str, final String... searchStrs) {
		...
		for (final String search : searchStrs) {
			...
			tmp = StringUtils.lastIndexOf(str, search, str.length());
			if (tmp > ret) {
				ret = tmp;
			}
		}
	...
	/**
	 * <p>
	 * Joins the elements of the provided varargs into a single String
	 * containing the provided elements.
	 * </p>
	 *
	 * <p>
	 ...
	 *            the separator character to use, null treated as ""
	 * @param objects
	 *            the varargs providing the values to join together.
	 ...
	 * {@link Pattern#DOTALL} option is NOT automatically added. To use the
	 * DOTALL option prepend <code>"(?s)"</code> to the regex. DOTALL is also
	 * known as single-line mode in Perl.
	 * </p>
	 *
	 * <pre>
	...
	/**
	 * <p>
	 * Removes the first substring of the text string that matches the given
	 * regular expression.
	 * </p>
	 *
	 * This method is a {@code null} safe equivalent to:
	 ...
	 * @param regex
	 *            the regular expression to which this string is to be matched
	 * @return the text with the first replacement processed, {@code null} if
	 *         null String input
	 *
	 * @throws java.util.regex.PatternSyntaxException
	 *             if the regular expression's syntax is invalid
	 ...
	 * </pre>
	 *
	 * @see #replaceIgnoreCase(String text, String searchString, String
	 *      replacement, int max)
	 * @param text
	 *            text to search and replace in, may be null
	 * @param searchString
	 ...
	 * {@link Pattern#DOTALL} option. DOTALL is also known as single-line mode
	 * in Perl.
	 * </p>
	 *
	 ...
	 * <p>
	 * Replaces a String with another String inside a larger String, for the
	 * first {@code max} values of the search String, case
	 ...
	 * {@link #replaceEachRepeatedly(String, String[], String[])} and
	 ...
	 * @since 2.4
	 * @since 3.0 Changed signature from length(String) to length(String)
	 */
	 ...
	 * @param ch
	 *            the char to count
	 * @return the number of occurrences, 0 if the String is {@code null}
	 * @since 3.4
	 */
	 ...
	 */
	public static boolean isAsciiPrintable(final String cs) {
		if (cs == null) {
			return false;
		}
		final int sz = cs.length();
	 ...
	 * @since 3.0 Changed signature from isNumeric(String) to isNumeric(String)
	 * @since 3.0 Changed "" to return false and not true
	 */
	 ...
	 * @param cs
	 *            the String to check, may be null
	 * @return {@code true} if the String contains both uppercase and lowercase
	 *         characters
	 * @since 3.5
	 */
	public static boolean isMixedCase(final String cs) {
	 ...
	 */
	public static <T extends String> T defaultIfBlank(final T str, final T defaultStr) {
	 ...
	 * @see StringUtils#defaultString(String, String)
	 */
	public static <T extends String> T defaultIfEmpty(final T str, final T defaultStr) {
	 ...
	 * @param shift
	 *            number of time to shift (positive : right shift, negative :
	 *            left shift)
	 * @return the rotated String, or the original String if {@code shift == 0},
	 ...
	 * This will turn "Now is the time for all good men" into
	 ...
	 * <li>If {@code maxWidth} is less than {@code abbrevMarker.length + 1},
	 * throw an {@code IllegalArgumentException}.</li>
	 * <li>In no case will it return a String of length greater than
	 * {@code maxWidth}.</li>
	 * </ul>
	 *
	 ...
	 *
	 * <p>
	 * Works like {@code abbreviate(String, String, int)}, but allows you to
	 ...
	 * following the replacement marker, but it will appear somewhere in the
	 * result.
	 *
	 * <p>
	 * In no case will it return a String of length greater than
	 ...
	 */
	public static int indexOfDifference(final String cs1, final String cs2) {
		if (cs1 == cs2) {
			return INDEX_NOT_FOUND;
		}
	 ...
	 *
	 * <p>
	 * The implementation uses a single-dimensional array of length s.length() +
	 * 1. See <a href=
	 ...
	 *        to getLevenshteinDistance(String, String)
	 ...
	 */
	@Deprecated
	public static int getLevenshteinDistance(String s, String t, final int threshold) {
		if (s == null || t == null) {
			throw new IllegalArgumentException("Strings must not be null");
		}
		if (threshold < 0) {
	 ...
	 * from
	 * <a href="http://en.wikipedia.org/wiki/Jaro%E2%80%93Winkler_distance">http
	 * ://en.wikipedia.org/wiki/Jaro%E2%80%93Winkler_distance</a>.
	 * </p>
	 *
	 * <pre>
	 ...
	 */
	@Deprecated
	public static double getJaroWinklerDistance(final String first, final String second) {
	...
	private static int[] matches(final String first, final String second) {
		String max, min;
	 ...
	 * such as Sublime Text, TextMate, Atom and others. One point is given for
	 * every matched character. Subsequent matches yield two bonus points. A
	 * higher score indicates a higher similarity.
	 * </p>
	 *
	 * <pre>
	 ...
	 *            null
	 * @param locale
	 *            This string matching logic is case insensitive. A locale is
	 *            necessary to normalize both Strings to lower case.
	 * @return result score
	 * @throws IllegalArgumentException
	 *             if either String input {@code null} or Locale input
	 *             {@code null}
	 * @since 3.4
	 * @deprecated as of 3.6, use commons-text <a href=
	 ...
	 */
	@Deprecated
	public static int getFuzzyDistance(final String term, final String query, final Locale locale) {
