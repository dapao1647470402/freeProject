...
INSERT INTO `freepj`.`t_authority` (`AUTHORITY_ID`, `AUTHORITY_NAME`, `INS_DATE`, `INS_USER_ID`, `INS_PROGRAM`, `UPD_DATE`, `UPD_USER_ID`, `UPD_PROGRAM`, `LOCK_VERSION`) VALUES ('5', '至高权限', '2018-08-25 11:53:25', 'admin', NULL, '2018-08-25 11:53:35', 'admin', NULL, '0');
